...
public class Produto : IValidatableObject
{
    ...
    [StringLength(20, MinimumLength = 1 , ErrorMessage = "O nome deve conter entre 1 e 20 caracteres")]
    [PrimeiraLetraMaiuscula]
    public string Nome { get; set; }

    [Required]
    [StringLength(300, MinimumLength = 10, ErrorMessage = "A descrição deve conter entre {2} e {1} caracteres" )]
